...
var optionsColumn = {
  ...
  series: [{
      name: "共機",
      data: [5, 5, 25, 10, 4, 8, 9, 11, 3, 2, 2, 3, 2, 27, 18, 23, 16, 12, 13, 16, 7, 8, 9, 26, 3, 10, 9, 10, 6, 11],
    }, {
      name: "共艦",
      data: [6, 5, 5, 5, 7, 7, 4, 4, 4, 4, 5, 5, 6, 8, 9, 8, 13, 6, 6, 8, 8, 9, 7, 7, 7, 6, 6, 7, 7, 8],
    }, {
      name: "氣球",
...
var options = {
  series: [{
    name: '共機架次',
    type: 'column',
    data: [325, 439, 510, 531, 497, 487, 512]
  }, {
    name: '共機逾越架次',
    type: 'line',
  ...
  },
  {
    name: '共艦艘次',
    type: 'column',
    data: [205, 208, 191, 239, 208, 250, 249]
  }, {
    name: '共機+共艦',
    type: 'line',
    data: [530, 647, 701, 770, 705, 737, 761]
  }, {
    name: '飛彈飛越',
    type: 'line',
    data: [0, 3, 1, 1, 1, 2, 1]
