...
var optionsColumn = {
  ...
  series: [{
      name: "共機",
      data: [24, 26, 27, 31, 22, 14, 13, 3, 27, 21, 28, 17, 6, 9, 10, 8, 5, 15, 19, 41, 23, 6, 9, 4, 22, 22, 22, 21, 10, 6],
    }, {
      name: "共艦",
      data: [11, 9, 14, 13, 10, 5, 6, 6, 7, 6, 6, 9, 5, 5, 5, 6, 6, 6, 7, 7, 7, 7, 6, 5, 5, 5, 5, 7, 6, 5],
    }, {
      name: "氣球",
...
var options = {
  series: [{
    name: '共機架次',
    type: 'column',
    data: [286, 510, 531, 497, 487, 512, 448]
  }, {
    name: '共機逾越架次',
    type: 'line',
    data: [198, 314, 375, 359, 362, 337, 324]
  },
  {
    name: '共艦艘次',
    type: 'column',
    data: [123, 191, 239, 208, 250, 249, 224]
  }, {
    name: '共機+共艦',
    type: 'line',
    data: [409, 701, 770, 705, 737, 761, 672]
  }, {
    name: '飛彈飛越',
    type: 'line',
    data: [1, 1, 1, 1, 2, 1, 2]
