...
var optionsColumn = {
  ...
  series: [{
      name: "共機",
      data: [12, 8, 54, 57, 15, 16, 12, 5, 5, 11, 20, 37, 11, 3, 4, 4, 17, 26, 48, 4, 0, 1, 0, 18, 11, 58, 18, 26, 17, 11],
    }, {
      name: "共艦",
      data: [9, 9, 6, 6, 7, 6, 5, 6, 7, 7, 7, 7, 6, 6, 10, 10, 7, 7, 9, 8, 8, 5, 4, 8, 10, 9, 7, 7, 8, 7],
    }, {
      name: "氣球",
...
var options = {
  series: [{
    name: '共機架次',
    type: 'column',
    data: [215, 531, 497, 487, 512, 448, 464]
  }, {
    name: '共機逾越架次',
    type: 'line',
    data: [153, 375, 359, 362, 337, 324, 347]
  },
  {
    name: '共艦艘次',
    type: 'column',
    data: [75, 239, 208, 250, 249, 224, 221]
  }, {
    name: '共機+共艦',
    type: 'line',
    data: [290, 770, 705, 737, 761, 672, 685]
  }, {
    name: '飛彈飛越',
    type: 'line',
    data: [0, 1, 1, 2, 1, 2, 1]
