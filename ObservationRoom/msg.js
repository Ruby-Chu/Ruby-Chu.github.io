...
var options = {
  series: [{
    name: '本月共機架次',
    type: 'column',
    data: [368, 487, 512, 448, 464, 341, 409, 0, 0]
  }, {
    name: '本月共機逾越架次',
    type: 'line',
    data: [268, 362, 337, 324, 347, 249, 211, 0, 0]
  },
  {
    name: '本月共艦艘次',
    type: 'column',
    data: [165, 250, 249, 224, 221, 191, 233, 0, 0]
  }, {
    name: 'Total',
    type: 'line',
    data: [533, 737, 761, 672, 685, 532, 642, 0, 0]
  }, {
    name: '飛彈飛越外太空',
    type: 'line',
    data: [1, 2, 1, 2, 1, 1, 1, 3, 0]
  }],
  chart: {
    height: 270,
    type: 'line',
